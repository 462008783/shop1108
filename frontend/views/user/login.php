        ...
        <div class="login_form fl">
            <form action="" method="post" id="login_form">
                ...
                <ul>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" class="chb" name="LoginForm[rememberMe]" id="rememberMe" /> 保存登录信息
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<script type="text/javascript">
   $(function () {
       ...
       $(".login_btn").click(function () {
           $.post("/user/login",$("#login_form").serialize(),function (user) {
               //console.dir(user);
               //判断
               if(user.status==1) {
