    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl <?=Yii::$app->controller->id."/".Yii::$app->controller->action->id==="index/index"?"":"cat1";?>"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd <?=Yii::$app->controller->id."/".Yii::$app->controller->action->id==="index/index"?"":"none";?>">
                ...
                <!--通过父级ID找到一级分类-->
                <?php
                    foreach (\backend\models\Category::find()->where(['pid'=>0])->all() as $k1=>$v1):
                ?>
                <div class="cat <?= $k1==0?"item1":"" ?>" >
                    ...
                    <div class="cat_detail">
                        ...
                        <!--通过父级ID找到二级分类-->
                        <?php
                            foreach (\backend\models\Category::find()->where(['pid'=>$v1->id])->all() as $k2=>$v2):
                            ?>
                            ...
                            <dl class="<?=$k2==0?"dl_1st":""?>">
                                ...
                                <!--通过父级ID找到三级分类-->
                                <?php
                                foreach (\backend\models\Category::find()->where(['pid'=>$v2->id])->all() as $k3=>$v3):
                                    ?>
